...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { address: @information.address, email: @information.email, fax: @information.fax, mobile: @information.mobile, phone: @information.phone, youtube: @information.youtube }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { address: @information.address, email: @information.email, fax: @information.fax, mobile: @information.mobile, phone: @information.phone, youtube: @information.youtube }
    assert_redirected_to information_path(assigns(:information))
  end
