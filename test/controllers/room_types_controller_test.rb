...
class RoomTypesControllerTest < ActionController::TestCase
  ...
  test "should create room_type" do
    assert_difference('RoomType.count') do
      post :create, room_type: { description: @room_type.description, room_bed: @room_type.room_bed, room_features: @room_type.room_features, room_size: @room_type.room_size, room_type_name: @room_type.room_type_name, room_view: @room_type.room_view }
    end
  ...
  test "should update room_type" do
    patch :update, id: @room_type, room_type: { description: @room_type.description, room_bed: @room_type.room_bed, room_features: @room_type.room_features, room_size: @room_type.room_size, room_type_name: @room_type.room_type_name, room_view: @room_type.room_view }
    assert_redirected_to room_type_path(assigns(:room_type))
  end
